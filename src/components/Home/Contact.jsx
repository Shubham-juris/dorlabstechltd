  ...
  return (
    <section className="bg-blue-900 py-16 px-4 md:px-10 lg:px-20 text-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center md:text-left">CONTACT US</h2>

        <div className="flex flex-col md:flex-row gap-12">
          {/* Form Section */}
          <div className="w-full md:w-1/2">
            <h3 className="text-xl md:text-2xl font-bold mb-6">Reach out to us!</h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-xs mt-4">
                ...
                and
                <a href="#" className="text-white underline mx-1">Terms of Service</a>
                apply.
              </p>
            </form>
          </div>
          ...
          {/* Info Section */}
          <div className="w-full md:w-1/2">
            <h3 className="text-xl md:text-2xl font-bold mb-6">Call or Email us</h3>

            <p className="mb-6 text-sm md:text-base">
              We value our customers and invite you to visit us during our regular
              business hours. Alternatively, you can reach out via email anytime, and
              we guarantee a prompt response.
            </p>

            <div className="mb-8 text-sm md:text-base">
              <h4 className="text-xl font-bold mb-4">Dorlabs Tech</h4>
              <p className="mb-2">2002 20 Street #5, Bowden, AB, Canada</p>
