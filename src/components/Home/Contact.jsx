...
function Contact() {
  ...
  return (
    <section className="bg-blue-900 p-20 text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-12">CONTACT US</h2>
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="w-full md:w-1/2">
            <h3 className="text-xl font-bold mb-6">Call or Email us</h3>
